...
_swigfaiss_gpu.METRIC_INNER_PRODUCT_swigconstant(_swigfaiss_gpu)
METRIC_INNER_PRODUCT = _swigfaiss_gpu.METRIC_INNER_PRODUCT

_swigfaiss_gpu.METRIC_L2_swigconstant(_swigfaiss_gpu)
...
_swigfaiss_gpu.INDICES_CPU_swigconstant(_swigfaiss_gpu)
INDICES_CPU = _swigfaiss_gpu.INDICES_CPU

_swigfaiss_gpu.INDICES_IVF_swigconstant(_swigfaiss_gpu)
INDICES_IVF = _swigfaiss_gpu.INDICES_IVF

_swigfaiss_gpu.INDICES_32_BIT_swigconstant(_swigfaiss_gpu)
INDICES_32_BIT = _swigfaiss_gpu.INDICES_32_BIT

_swigfaiss_gpu.INDICES_64_BIT_swigconstant(_swigfaiss_gpu)
...
_swigfaiss_gpu.Device_swigconstant(_swigfaiss_gpu)
Device = _swigfaiss_gpu.Device

_swigfaiss_gpu.Unified_swigconstant(_swigfaiss_gpu)
